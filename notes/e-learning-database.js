...
const eContent = [
    // --- CHOTODER JONYO (KIDS) ---
    { id: 'english', section: 'kids', title: 'ABC Alphabet Fun', icon: '🔤', desc: 'ছবি ও শব্দ সহ ইংরেজি বর্ণমালা শেখা।', badge: 'English', badgeClass: 'badge-english', url: 'notes/English-reading-skills.html' },
    ...
    { id: 'english', section: 'kids', title: 'Practice Note', icon: '🎵', desc: 'মজার ইংরেজি অ্যানিমেশন।', badge: 'English', badgeClass: 'badge-english', url: 'notes/Interactive Practice Sheet.html' },
