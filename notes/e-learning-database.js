...
const eContent = [
    ...
    { id: 'english', section: 'kids', title: 'Practice Note', icon: '🎵', desc: 'মজার ইংরেজি অ্যানিমেশন।', badge: 'English', badgeClass: 'badge-english', url: 'Interactive Practice Sheet.html' },
    ...
    { id: 'english', section: 'seniors', title: 'Number & Gender', icon: '👥', desc: 'Singular, Plural এবং Gender এর ব্যবহার।', badge: 'English', badgeClass: 'badge-english', url: 'Wh-Questions Special Study Sheet - Class 5.pdf' },
    { id: 'english', section: 'seniors', title: 'WH-Question', icon: '❓', desc: 'Who, What এবং How ইত্যাদি এর ব্যবহার।', badge: 'English', badgeClass: 'badge-english', url: 'Class_5_Wh_Questions.html' },
    { id: 'english', section: 'seniors', title: 'Voice Change', icon: '🗣️', desc: 'Active & Passive Voice রূপান্তরের কৌশল।', badge: 'English', badgeClass: 'badge-english', url:'voice.html' },
    ...
    { id: 'gonit', section: 'seniors', title: 'জ্যামিতি (Geometry)', icon: '📐', desc: 'রেখা, কোণ, ত্রিভুজ ও চতুর্ভুজের ধারণা।', badge: 'গণিত', badgeClass: 'badge-gonit', url: 'geometry_notes_class5.html' },
